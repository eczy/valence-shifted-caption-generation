...
4. Download the zipped Amazon data, provided by the team elsewhere - the necessary data has already been parsed (parsing yourself will take several days of computing time). Unzip the file and move 'amazonRawData', 'amazon_counts', 'amazon_pairTuples', and 'amazon_sentenceTuples' into 595-valence-shifting-captions/valanceModel/.
5. Download the Flickr8k dataset and paste both `Flickr8k_text/` and `Flicker8k_Dataset/` into 595-valence-shifting-captions/Image-Captioning/.
